...
public class PointBlankGunsReloadListener extends JsonMapReloadListener {

    public PointBlankGunsReloadListener() {
        super("guns/pointblank");
    }

    @Override
    protected void apply(Map<Identifier, JsonElement> elements, ResourceManager resourceManager, ProfilerFiller profiler) {
        Map<Identifier, Double> guns = new HashMap<>();
        Map<Identifier, Double> attachments = new HashMap<>();
        Map<Identifier, Double> muzzle = new HashMap<>();
