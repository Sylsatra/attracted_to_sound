...
/**
 * Pick-up-and-throw helper goal: throws allies toward sound sources.
 *
...
public class PickUpAndThrowToSoundGoal extends Goal {
    ...
    public boolean canUse() {
        ...
        if (canPickUpTagStr == null || canPickUpTagStr.isEmpty()) return false;
        ResourceLocation pickUpRl = ResourceLocation.tryParse(canPickUpTagStr);
        if (pickUpRl == null) return false;
        TagKey<EntityType<?>> canPickUpTag = TagKey.create(Registry.ENTITY_TYPE_REGISTRY, pickUpRl);
        ...
        if (canBePickedUpTagStr == null || canBePickedUpTagStr.isEmpty()) return false;
        ResourceLocation bePickedRl = ResourceLocation.tryParse(canBePickedUpTagStr);
        if (bePickedRl == null) return false;
        TagKey<EntityType<?>> canBePickedUpTag = TagKey.create(Registry.ENTITY_TYPE_REGISTRY, bePickedRl);
