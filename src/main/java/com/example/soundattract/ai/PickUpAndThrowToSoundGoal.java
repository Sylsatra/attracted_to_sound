...
public class PickUpAndThrowToSoundGoal extends Goal {
    ...
    public boolean canStart() {
        ...
        TagKey<EntityType<?>> canPickUpTag = TagKey.of(RegistryKeys.ENTITY_TYPE, new Identifier(canPickUpTagStr));
        ...
        TagKey<EntityType<?>> canBePickedUpTag = TagKey.of(RegistryKeys.ENTITY_TYPE, new Identifier(canBePickedUpTagStr));
