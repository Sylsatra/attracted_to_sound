...
@net.neoforged.fml.common.EventBusSubscriber(modid = com.example.soundattract.SoundAttractMod.MOD_ID, bus = net.neoforged.fml.common.EventBusSubscriber.Bus.GAME)
