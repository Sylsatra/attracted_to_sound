...
public class ModLootModifiers {
    ...
    public static final RegistryObject<Codec<AddEnchantedBookModifier>> ADD_ENCHANTED_BOOK =
            LOOT_MODIFIER_SERIALIZERS.register("add_enchanted_book", AddEnchantedBookModifier.CODEC);
