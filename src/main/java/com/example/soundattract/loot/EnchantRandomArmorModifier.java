...
public class EnchantRandomArmorModifier extends LootModifier {
    ...
    public EnchantRandomArmorModifier(LootItemCondition[] conditions, int order) {
    ...
    protected @NotNull ObjectArrayList<ItemStack> doApply(ObjectArrayList<ItemStack> generatedLoot, LootContext context) {
        ...
        Holder<Enchantment> concealHolder = enchantmentRegistry.getOrThrow(ModEnchantments.CONCEAL);
