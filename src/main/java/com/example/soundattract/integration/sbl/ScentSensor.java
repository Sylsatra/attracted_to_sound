...
public class ScentSensor<E extends PathfinderMob> extends ExtendedSensor<E> {
    ...
    public static final SensorType<ScentSensor<?>> TYPE = new SensorType<>(ScentSensor::new);
    ...
    protected void doTick(ServerLevel level, E entity) {
        ...
        if (entity.getTarget() != null && entity.getTarget().isAlive()) {
            BrainUtil.clearMemory(entity, SCENT_TARGET);
            return;
        }
        ...
        ScentManager scentManager = ScentManager.get(level).orElse(null);
        ...
        if (bestNode != null) {
            ...
            BrainUtil.setMemory(entity, SCENT_TARGET, bestNode.getBlockPos());
