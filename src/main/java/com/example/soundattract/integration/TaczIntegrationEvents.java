...
public class TaczIntegrationEvents {
    ...
    public static void onGunReload(Object event) {
        ...
        if (entity instanceof Player player && !player.level.isClientSide()) {
            SoundEvent taczGunSound = ForgeRegistries.SOUND_EVENTS.getValue(ResourceLocation.tryParse(TACZ_GUN_SOUND_ID));
    ...
    public static void onGunShoot(Object event) {
        ...
        if (isPlayer) {
            ...
            SoundTracker.addSound(
                    ForgeRegistries.SOUND_EVENTS.getValue(ResourceLocation.tryParse(TACZ_GUN_SOUND_ID)),
                    player.blockPosition(),
                    player.level.dimension().location().toString(),
                    range,
                    weight,
