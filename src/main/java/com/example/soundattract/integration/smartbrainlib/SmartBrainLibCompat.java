...
public final class SmartBrainLibCompat {
    ...
    private static final class Proxy {
        ...
        private static boolean tryAttach(Mob mob) {
            ...
            try {
                Class<?> BrainUtilClass = Class.forName("net.tslat.smartbrainlib.util.BrainUtil");
                Object behaviours = BrainUtilClass.getMethod("getAllBehaviours", Object.class).invoke(null, brain);
                ...
                BrainUtilClass.getMethod("addMemories", Object.class, Object[].class).invoke(null, brain, new Object[]{
        ...
        private static void addSensor(Object brain, Object sensorType, Object sensor) {
            try {
                Class<?> BrainUtilClass = Class.forName("net.tslat.smartbrainlib.util.BrainUtil");
                BrainUtilClass.getMethod("addSensor", Object.class, Object.class, Object.class).invoke(null, brain, sensorType, sensor);
            } catch (Throwable t) {
                if (com.example.soundattract.config.SoundAttractConfig.COMMON.debugLogging.get()) {
        ...
        private static void addBehaviour(Object brain, int priority, Object activity, Object behaviour) {
            try {
                Class<?> BrainUtilClass = Class.forName("net.tslat.smartbrainlib.util.BrainUtil");
                BrainUtilClass.getMethod("addBehaviour", Object.class, int.class, Object.class, Object.class)
