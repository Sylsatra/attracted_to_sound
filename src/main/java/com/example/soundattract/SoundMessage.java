...
public class SoundMessage {
    ...
    public static final ResourceLocation VOICE_CHAT_SOUND_ID = ResourceLocation.tryParse(SoundAttractMod.MOD_ID + ":voice_chat");
    ...
    public static void handle(SoundMessage msg, Supplier<NetworkEvent.Context> ctx) {
        ...
        ctx.get().enqueueWork(() -> {
            ...
            if (sender != null) {
                 ...
                 if (server != null) {
                     serverLevel = server.getLevel(ResourceKey.create(Registry.DIMENSION_REGISTRY, msg.dimension));
                 }
            }
