...
public class SoundAttractClientEvents {
    ...
    public static void onPlaySoundEvent(net.minecraft.client.sound.SoundInstance soundInstance) {
        ...
        if (soundRL == null || soundRL.equals(SoundMessagePayload.VOICE_CHAT_SOUND_ID)) {
            return;
        }
        ...
        String animatorClass = null;


        if (se.getId().getPath().contains("step") && clientPlayer.squaredDistanceTo(x, y, z) < 1.5 * 1.5) {
            ...
            animatorClass = currentAction.name();
