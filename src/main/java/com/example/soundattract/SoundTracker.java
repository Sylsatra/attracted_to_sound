...
public class SoundTracker {
    ...
    private static boolean isCustomSolid(BlockState state, Block block) {
        return isBlockInConfigList(state, block, SoundAttractConfig.CUSTOM_SOLID_BLOCKS_CACHE) || state.isSolidRender(null, BlockPos.ZERO);
    }
    private static boolean isCustomNonSolid(BlockState state, Block block) {
        return isBlockInConfigList(state, block, SoundAttractConfig.CUSTOM_NON_SOLID_BLOCKS_CACHE) || !state.isSolidRender(null, BlockPos.ZERO);
    }
