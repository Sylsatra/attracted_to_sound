        ...
        if (camo.getLayers().isEmpty()) return;
            ...
            if (upperStrength > 0) {
                ...
                if (upperSmudge != null) {
                    ...
                    model.renderToBuffer(poseStack, upperConsumer, packedLight, OverlayTexture.pack(0, 10), 0xFFFFFFFF);
            ...
            if (lowerStrength > 0) {
                ...
                if (lowerSmudge != null) {
                    ...
                    model.renderToBuffer(poseStack, lowerConsumer, packedLight, OverlayTexture.pack(0, 10), 0xFFFFFFFF);
