...
public class SoundAttractConfig {
    ...
    public static class Common {
        ...
        Common(ForgeConfigSpec.Builder builder) {
            ...
            attractedEntities = builder.comment("List of mobs that will be attracted to sounds. Example: ['minecraft:zombie', 'minecraft:skeleton'].")
                .defineList("attractedEntities", java.util.Arrays.asList(
            ...
            nonPlayerSoundIdList = builder.comment("List of non-player sound IDs that mobs can be attracted to. Format: 'soundId;range;weight'. Example: 'minecraft:block.lever.click;5;3'")
                .defineList("nonPlayerSoundIdList", java.util.Arrays.asList(
            ...
            soundIdWhitelist = builder.comment("Whitelist of sound IDs to process (all others will be ignored for performance). Example: 'minecraft:block.note_block.bass'")
                .defineList("soundIdWhitelist", java.util.Arrays.asList(
            ...
            customWoolBlocks = builder.comment("Custom wool blocks").defineList("customWoolBlocks", new ArrayList<String>(), obj -> obj instanceof String);
            ...
            customSolidBlocks = builder.comment("Custom solid blocks").defineList("customSolidBlocks", new ArrayList<String>(), obj -> obj instanceof String);
            ...
            customNonSolidBlocks = builder.comment("Custom non-solid blocks").defineList("customNonSolidBlocks", new ArrayList<String>(), obj -> obj instanceof String);
            ...
            customThinBlocks = builder.comment("Custom thin blocks").defineList("customThinBlocks", new ArrayList<String>(), obj -> obj instanceof String);
            ...
            customLiquidBlocks = builder.comment("Custom liquid blocks (resource locations, e.g. 'minecraft:lava', 'modid:custom_fluid')").defineList("customLiquidBlocks", new ArrayList<String>(), obj -> obj instanceof String);
            ...
            camouflageSets = builder.comment("Camouflage sets. Format: color;helmet;chestplate;leggings;boots[;block1;block2;...]")
                .defineList("camouflageSets", java.util.Arrays.asList(
                    // White
            ...
            parcoolAnimatorSounds = builder.comment("List of Parcool animator sound configs. Format: 'AnimatorClass;soundId;range;weight;volume;pitch'. Example: 'VaultAnimator;parcool:grabbing;10;1.0;1.25;0.6'")
                .defineList("parcoolAnimatorSounds", java.util.Arrays.asList(
                    // Vault
            ...
            parcoolAnimatorSoundConfigs = builder.comment("List of Parcool animator sound configs. Format: 'animatorClass;soundId;range;weight;volume;pitch'. Example: 'VaultAnimator;parcool:grabbing;10;1.0;1.25;0.6'")
                .defineList("parcoolAnimatorSoundConfigs", new ArrayList<>(), obj -> {
                    if (!(obj instanceof String str)) return false;
                    String[] parts = str.split(";", 6);
                    if (parts.length != 6) return false;
                    try {
    ...
    public static void bakeConfig() {
        ...
        if (COMMON.parcoolAnimatorSoundConfigs.get().isEmpty()) {
            ...
            COMMON.parcoolAnimatorSoundConfigs.set(new ArrayList<>(defaults));
        }
    ...
    public static final ForgeConfigSpec.ConfigValue<List<? extends String>> parcoolAnimatorSounds = COMMON.parcoolAnimatorSounds;
