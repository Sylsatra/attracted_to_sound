...
public class GeneralConfig {
    ...
    public static final ModConfigSpec.BooleanValue ENABLE_DATA_DRIVEN;
    public static final ModConfigSpec.ConfigValue<String> DATAPACK_PRIORITY;
    public static final ModConfigSpec.BooleanValue ENABLE_FLEE_FROM_UNSEEN_ATTACKER_GOAL;
    public static final ModConfigSpec.DoubleValue SOUND_SWITCH_RATIO;
    public static final ModConfigSpec.DoubleValue SOUND_NOVELTY_BONUS_WEIGHT;
    public static final ModConfigSpec.IntValue SOUND_NOVELTY_TIME_TICKS;
    public static final ModConfigSpec.IntValue CONFIG_SCHEMA_VERSION;

    public static final ModConfigSpec.BooleanValue ENABLE_PLAYER_ACTION_SOUNDS;
    public static final ModConfigSpec.ConfigValue<List<? extends String>> PLAYER_ACTION_RANGES;
    public static final ModConfigSpec.ConfigValue<List<? extends String>> PLAYER_ACTION_WEIGHTS;
    public static final ModConfigSpec.DoubleValue PLAYER_ACTION_CHECK_RADIUS;

    public static final ModConfigSpec.ConfigValue<List<? extends String>> ATTRACTED_ENTITIES;
    public static final ModConfigSpec.ConfigValue<List<? extends String>> MOB_BLACKLIST;
    public static final ModConfigSpec.ConfigValue<List<? extends String>> STEALTH_BYPASS_MOB_IDS;
    public static final ModConfigSpec.ConfigValue<List<? extends String>> STEALTH_BYPASS_MOD_NAMESPACES;
    public static final ModConfigSpec.IntValue SOUND_LIFETIME_TICKS;
    public static final ModConfigSpec.DoubleValue ARRIVAL_DISTANCE;
    public static final ModConfigSpec.DoubleValue MOB_MOVE_SPEED;
    public static final ModConfigSpec.DoubleValue FOLLOW_LEADER_MIN_SOUND_WEIGHT_TO_SPREAD_OUT;
    public static final ModConfigSpec.DoubleValue HIGH_SOUND_WEIGHT_TARGET_OVERRIDE;

    public static final ModConfigSpec.ConfigValue<List<? extends String>> SOUND_ID_WHITELIST;
    public static final ModConfigSpec.ConfigValue<List<? extends String>> SOUND_ID_BLACKLIST;
    public static final ModConfigSpec.ConfigValue<List<? extends String>> SOUND_DEFAULTS;

    public static final ModConfigSpec.IntValue MAX_GROUP_SIZE;
    public static final ModConfigSpec.DoubleValue LEADER_GROUP_RADIUS;
    public static final ModConfigSpec.DoubleValue GROUP_DISTANCE;
    public static final ModConfigSpec.DoubleValue LEADER_SPACING_MULTIPLIER;
    public static final ModConfigSpec.IntValue NUM_EDGE_SECTORS;
    public static final ModConfigSpec.IntValue GROUP_UPDATE_INTERVAL;
    public static final ModConfigSpec.IntValue MAX_LEADERS;
    public static final ModConfigSpec.BooleanValue SKIP_SOUND_SCAN_WHEN_HAS_TARGET;
    public static final ModConfigSpec.IntValue MAX_MUFFLING_RAYCASTS_PER_TICK;


    public static final ModConfigSpec.BooleanValue ENABLE_BLOCK_MUFFLING;
    public static final ModConfigSpec.DoubleValue MUFFLING_FACTOR_WOOL;
    public static final ModConfigSpec.DoubleValue MUFFLING_FACTOR_SOLID;
    public static final ModConfigSpec.DoubleValue MUFFLING_FACTOR_NON_SOLID;
    public static final ModConfigSpec.DoubleValue MUFFLING_FACTOR_THIN;
    public static final ModConfigSpec.DoubleValue MUFFLING_FACTOR_LIQUID;
    public static final ModConfigSpec.DoubleValue MUFFLING_FACTOR_AIR;
    public static final ModConfigSpec.ConfigValue<List<? extends String>> CUSTOM_WOOL_BLOCKS;
    public static final ModConfigSpec.ConfigValue<List<? extends String>> CUSTOM_SOLID_BLOCKS;
    public static final ModConfigSpec.ConfigValue<List<? extends String>> CUSTOM_NON_SOLID_BLOCKS;
    public static final ModConfigSpec.ConfigValue<List<? extends String>> CUSTOM_THIN_BLOCKS;
    public static final ModConfigSpec.ConfigValue<List<? extends String>> CUSTOM_LIQUID_BLOCKS;
    public static final ModConfigSpec.ConfigValue<List<? extends String>> CUSTOM_AIR_BLOCKS;
    
    public static final ModConfigSpec.ConfigValue<List<? extends String>> SPECIAL_MOB_PROFILES;
    public static final ModConfigSpec.ConfigValue<List<? extends String>> SPECIAL_PLAYER_PROFILES;

    public static final ModConfigSpec.BooleanValue ENABLE_FLOOR_CREEK;
    public static final ModConfigSpec.DoubleValue FLOOR_CREEK_PROB_SWIMMING_CRAWLING;
    public static final ModConfigSpec.DoubleValue FLOOR_CREEK_PROB_SNEAKING;
    public static final ModConfigSpec.DoubleValue FLOOR_CREEK_PROB_WALKING;
    public static final ModConfigSpec.DoubleValue FLOOR_CREEK_PROB_SPRINTING;
    public static final ModConfigSpec.DoubleValue FLOOR_CREEK_PROB_JUMP;
    public static final ModConfigSpec.DoubleValue FLOOR_CREEK_DISTANCE_STEP;

    public static final ModConfigSpec.BooleanValue ENABLE_ARROW_INVESTIGATION;
    public static final ModConfigSpec.DoubleValue ARROW_NEAR_MISS_RADIUS;
    public static final ModConfigSpec.DoubleValue ARROW_IMPACT_RADIUS;
    public static final ModConfigSpec.IntValue ARROW_INVESTIGATION_OFFSET;
    public static final ModConfigSpec.IntValue ARROW_INVESTIGATION_COOLDOWN_TICKS;
    public static final ModConfigSpec.DoubleValue ARROW_REVERSE_EXTRAPOLATE_MAX_DISTANCE;
    public static final ModConfigSpec.BooleanValue ARROW_INVESTIGATION_RESPECT_CURRENT_TARGET;
    public static final ModConfigSpec.ConfigValue<List<? extends String>> INVESTIGATE_PROJECTILE_IDS;

    static {
        BUILDER.comment("Sound Attract Mod - General Configuration").push("general");

        DEBUG_LOGGING = BUILDER.comment("Enable debug logging for troubleshooting.")
                .define("debugLogging", false);

        ENABLE_DATA_DRIVEN = BUILDER.comment("Enable datapack-based configuration.")
                .define("enableDataDriven", true);

        DATAPACK_PRIORITY = BUILDER.comment("Controls precedence when both datapacks and config define entries.")
                .define("datapackPriority", "datapack_over_config");

        ENABLE_FLEE_FROM_UNSEEN_ATTACKER_GOAL = BUILDER.comment("Enable mobs fleeing after being hurt by unseen attacker.")
                .define("enableFleeFromUnseenAttackerGoal", true);

        SOUND_SWITCH_RATIO = BUILDER.comment("Switching threshold factor.")
                .defineInRange("soundSwitchRatio", 0.5, 0.0, 1.0);

        SOUND_NOVELTY_BONUS_WEIGHT = BUILDER.comment("Novelty weight bonus.")
                .defineInRange("soundNoveltyBonusWeight", 9.5, 0.0, 10.0);

        SOUND_NOVELTY_TIME_TICKS = BUILDER.comment("How long a sound is considered 'new'.")
        ...
        BUILDER.push("player_action_sounds");
        ...
        PLAYER_ACTION_RANGES = BUILDER.comment(
                        "[DEPRECATED as of 6.3.3] Moved to soundattract/server-rules.toml (SERVER config).",
                        "The value here is no longer read at runtime; kept only so existing config files do not error.")
        ...
        MOB_BLACKLIST = BUILDER.defineList("mobBlacklist", Arrays.asList("minecraft:pig"), obj -> obj instanceof String);
        ...
        HIGH_SOUND_WEIGHT_TARGET_OVERRIDE = BUILDER.comment(
                "Mobs with role Leader, Edge, or Deserter that detect a sound with weight >= this value will drop their current combat target and navigate to the sound instead.\n" +
                "Set to 0 to disable. This override is ignored during active raids.")
                .defineInRange("highSoundWeightTargetOverride", 30.0, 0.0, 1000000.0);
        BUILDER.pop();

        BUILDER.push("sounds");
        SOUND_DEFAULTS = BUILDER.comment("Default sound properties for specific sounds. Format: 'sound_id;range;weight")
                .defineList("soundDefaults", Arrays.asList(
                                    ...
                                    "immersive_melodies:instruments.bagpipe.c8;32;32",
                                    "immersive_melodies:instruments.bagpipe.c7;32;32",
                                    "immersive_melodies:instruments.bagpipe.c6;32;32",
                                    "immersive_melodies:instruments.bagpipe.c5;32;32",
                                    "immersive_melodies:instruments.bagpipe.c4;32;32",
                                    "immersive_melodies:instruments.bagpipe.c3;32;32",
                                    "immersive_melodies:instruments.bagpipe.c2;32;32",
                                    "immersive_melodies:instruments.bagpipe.c1;32;32",
                                    "immersive_melodies:instruments.didgeridoo.c8;32;32",
                                    "immersive_melodies:instruments.didgeridoo.c7;32;32",
                                    "immersive_melodies:instruments.didgeridoo.c6;32;32",
                                    "immersive_melodies:instruments.didgeridoo.c5;32;32",
                                    "immersive_melodies:instruments.didgeridoo.c4;32;32",
                                    "immersive_melodies:instruments.didgeridoo.c3;32;32",
                                    "immersive_melodies:instruments.didgeridoo.c2;32;32",
                                    "immersive_melodies:instruments.didgeridoo.c1;32;32",
                                    "immersive_melodies:instruments.flute.c8;32;32",
                                    "immersive_melodies:instruments.flute.c7;32;32",
                                    "immersive_melodies:instruments.flute.c6;32;32",
                                    "immersive_melodies:instruments.flute.c5;32;32",
                                    "immersive_melodies:instruments.flute.c4;32;32",
                                    "immersive_melodies:instruments.flute.c3;32;32",
                                    "immersive_melodies:instruments.flute.c2;32;32",
                                    "immersive_melodies:instruments.flute.c1;32;32",
                                    "immersive_melodies:instruments.lute.c8;32;32",
                                    "immersive_melodies:instruments.lute.c7;32;32",
                                    "immersive_melodies:instruments.lute.c6;32;32",
                                    "immersive_melodies:instruments.lute.c5;32;32",
                                    "immersive_melodies:instruments.lute.c4;32;32",
                                    "immersive_melodies:instruments.lute.c3;32;32",
                                    "immersive_melodies:instruments.lute.c2;32;32",
                                    "immersive_melodies:instruments.lute.c1;32;32",
                                    "immersive_melodies:instruments.piano.c8;32;32",
                                    "immersive_melodies:instruments.piano.c7;32;32",
                                    "immersive_melodies:instruments.piano.c6;32;32",
                                    "immersive_melodies:instruments.piano.c5;32;32",
                                    "immersive_melodies:instruments.piano.c4;32;32",
                                    "immersive_melodies:instruments.piano.c3;32;32",
                                    "immersive_melodies:instruments.piano.c2;32;32",
                                    "immersive_melodies:instruments.piano.c1;32;32",
                                    "immersive_melodies:instruments.triangle.c8;32;32",
                                    "immersive_melodies:instruments.triangle.c7;32;32",
                                    "immersive_melodies:instruments.triangle.c6;32;32",
                                    "immersive_melodies:instruments.triangle.c5;32;32",
                                    "immersive_melodies:instruments.triangle.c4;32;32",
                                    "immersive_melodies:instruments.triangle.c3;32;32",
                                    "immersive_melodies:instruments.triangle.c2;32;32",
                                    "immersive_melodies:instruments.triangle.c1;32;32",
                                    "immersive_melodies:instruments.trumpet.c8;32;32",
                                    "immersive_melodies:instruments.trumpet.c7;32;32",
                                    "immersive_melodies:instruments.trumpet.c6;32;32",
                                    "immersive_melodies:instruments.trumpet.c5;32;32",
                                    "immersive_melodies:instruments.trumpet.c4;32;32",
                                    "immersive_melodies:instruments.trumpet.c3;32;32",
                                    "immersive_melodies:instruments.trumpet.c2;32;32",
                                    "immersive_melodies:instruments.trumpet.c1;32;32",
                                    "immersive_melodies:instruments.tiny_drum.c8;32;32",
                                    "immersive_melodies:instruments.tiny_drum.c7;32;32",
                                    "immersive_melodies:instruments.tiny_drum.c6;32;32",
                                    "immersive_melodies:instruments.tiny_drum.c5;32;32",
                                    "immersive_melodies:instruments.tiny_drum.c4;32;32",
                                    "immersive_melodies:instruments.tiny_drum.c3;32;32",
                                    "immersive_melodies:instruments.tiny_drum.c2;32;32",
                                    "immersive_melodies:instruments.tiny_drum.c1;32;32",
                                    "immersive_melodies:instruments.vielle.c8;32;32",
                                    "immersive_melodies:instruments.vielle.c7;32;32",
                                    "immersive_melodies:instruments.vielle.c6;32;32",
                                    "immersive_melodies:instruments.vielle.c5;32;32",
                                    "immersive_melodies:instruments.vielle.c4;32;32",
                                    "immersive_melodies:instruments.vielle.c3;32;32",
                                    "immersive_melodies:instruments.vielle.c2;32;32",
                                    "immersive_melodies:instruments.vielle.c1;32;32",
                                    "immersive_melodies:instruments.ender_bass.c8;32;32",
                                    "immersive_melodies:instruments.ender_bass.c7;32;32",
                                    "immersive_melodies:instruments.ender_bass.c6;32;32",
                                    "immersive_melodies:instruments.ender_bass.c5;32;32",
                                    "immersive_melodies:instruments.ender_bass.c4;32;32",
                                    "immersive_melodies:instruments.ender_bass.c3;32;32",
                                    "immersive_melodies:instruments.ender_bass.c2;32;32",
                                    "immersive_melodies:instruments.ender_bass.c1;32;32",
                                    "immersive_melodies:instruments.handpan.c8;32;32",
                                    "immersive_melodies:instruments.handpan.c7;32;32",
                                    "immersive_melodies:instruments.handpan.c6;32;32",
                                    "immersive_melodies:instruments.handpan.c5;32;32",
        ...
        SOUND_ID_BLACKLIST = BUILDER.comment("List of sound IDs that are explicitly ignored by mobs, even if loud.")
                .defineList("soundIdBlacklist", Arrays.asList(), obj -> obj instanceof String && net.minecraft.resources.Identifier.tryParse((String) obj) != null);
        SOUND_ID_WHITELIST = BUILDER.comment("List of sound IDs that can attract mobs. Mobs will ignore any sound not in this whitelist.")
                .defineList("soundIdWhitelist", Arrays.asList(
                            ...
                            "immersive_melodies:instruments.bagpipe.c8",
                            "immersive_melodies:instruments.bagpipe.c7",
                            "immersive_melodies:instruments.bagpipe.c6",
                            "immersive_melodies:instruments.bagpipe.c5",
                            "immersive_melodies:instruments.bagpipe.c4",
                            "immersive_melodies:instruments.bagpipe.c3",
                            "immersive_melodies:instruments.bagpipe.c2",
                            "immersive_melodies:instruments.bagpipe.c1",
                            "immersive_melodies:instruments.didgeridoo.c8",
                            "immersive_melodies:instruments.didgeridoo.c7",
                            "immersive_melodies:instruments.didgeridoo.c6",
                            "immersive_melodies:instruments.didgeridoo.c5",
                            "immersive_melodies:instruments.didgeridoo.c4",
                            "immersive_melodies:instruments.didgeridoo.c3",
                            "immersive_melodies:instruments.didgeridoo.c2",
                            "immersive_melodies:instruments.didgeridoo.c1",
                            "immersive_melodies:instruments.flute.c8",
                            "immersive_melodies:instruments.flute.c7",
                            "immersive_melodies:instruments.flute.c6",
                            "immersive_melodies:instruments.flute.c5",
                            "immersive_melodies:instruments.flute.c4",
                            "immersive_melodies:instruments.flute.c3",
                            "immersive_melodies:instruments.flute.c2",
                            "immersive_melodies:instruments.flute.c1",
                            "immersive_melodies:instruments.lute.c8",
                            "immersive_melodies:instruments.lute.c7",
                            "immersive_melodies:instruments.lute.c6",
                            "immersive_melodies:instruments.lute.c5",
                            "immersive_melodies:instruments.lute.c4",
                            "immersive_melodies:instruments.lute.c3",
                            "immersive_melodies:instruments.lute.c2",
                            "immersive_melodies:instruments.lute.c1",
                            "immersive_melodies:instruments.piano.c8",
                            "immersive_melodies:instruments.piano.c7",
                            "immersive_melodies:instruments.piano.c6",
                            "immersive_melodies:instruments.piano.c5",
                            "immersive_melodies:instruments.piano.c4",
                            "immersive_melodies:instruments.piano.c3",
                            "immersive_melodies:instruments.piano.c2",
                            "immersive_melodies:instruments.piano.c1",
                            "immersive_melodies:instruments.triangle.c8",
                            "immersive_melodies:instruments.triangle.c7",
                            "immersive_melodies:instruments.triangle.c6",
                            "immersive_melodies:instruments.triangle.c5",
                            "immersive_melodies:instruments.triangle.c4",
                            "immersive_melodies:instruments.triangle.c3",
                            "immersive_melodies:instruments.triangle.c2",
                            "immersive_melodies:instruments.triangle.c1",
                            "immersive_melodies:instruments.trumpet.c8",
                            "immersive_melodies:instruments.trumpet.c7",
                            "immersive_melodies:instruments.trumpet.c6",
                            "immersive_melodies:instruments.trumpet.c5",
                            "immersive_melodies:instruments.trumpet.c4",
                            "immersive_melodies:instruments.trumpet.c3",
                            "immersive_melodies:instruments.trumpet.c2",
                            "immersive_melodies:instruments.trumpet.c1",
                            "immersive_melodies:instruments.tiny_drum.c8",
                            "immersive_melodies:instruments.tiny_drum.c7",
                            "immersive_melodies:instruments.tiny_drum.c6",
                            "immersive_melodies:instruments.tiny_drum.c5",
                            "immersive_melodies:instruments.tiny_drum.c4",
                            "immersive_melodies:instruments.tiny_drum.c3",
                            "immersive_melodies:instruments.tiny_drum.c2",
                            "immersive_melodies:instruments.tiny_drum.c1",
                            "immersive_melodies:instruments.vielle.c8",
                            "immersive_melodies:instruments.vielle.c7",
                            "immersive_melodies:instruments.vielle.c6",
                            "immersive_melodies:instruments.vielle.c5",
                            "immersive_melodies:instruments.vielle.c4",
                            "immersive_melodies:instruments.vielle.c3",
                            "immersive_melodies:instruments.vielle.c2",
                            "immersive_melodies:instruments.vielle.c1",
                            "immersive_melodies:instruments.ender_bass.c8",
                            "immersive_melodies:instruments.ender_bass.c7",
                            "immersive_melodies:instruments.ender_bass.c6",
                            "immersive_melodies:instruments.ender_bass.c5",
                            "immersive_melodies:instruments.ender_bass.c4",
                            "immersive_melodies:instruments.ender_bass.c3",
                            "immersive_melodies:instruments.ender_bass.c2",
                            "immersive_melodies:instruments.ender_bass.c1",
                            "immersive_melodies:instruments.handpan.c8",
                            "immersive_melodies:instruments.handpan.c7",
                            "immersive_melodies:instruments.handpan.c6",
                            "immersive_melodies:instruments.handpan.c5",
                            ...
                            "soundattract:wooden_floor_creek", "soundattract:arrow_miss", "soundattract:arrow_impact"
                ), obj -> obj instanceof String && net.minecraft.resources.Identifier.tryParse((String) obj) != null);
        BUILDER.pop();


        BUILDER.push("groups");
        MAX_GROUP_SIZE = BUILDER.defineInRange("maxGroupSize", 64, 1, 128);
        LEADER_GROUP_RADIUS = BUILDER.defineInRange("leaderGroupRadius", 64.0, 1.0, 128.0);
        GROUP_DISTANCE = BUILDER.defineInRange("groupDistance", 128.0, 1.0, 256.0);
        LEADER_SPACING_MULTIPLIER = BUILDER.defineInRange("leaderSpacingMultiplier", 1.0, 0.1, 10.0);
        ...
        CUSTOM_WOOL_BLOCKS = BUILDER.defineList("customWoolBlocks", Arrays.asList(), obj -> obj instanceof String);
        CUSTOM_SOLID_BLOCKS = BUILDER.defineList("customSolidBlocks", Arrays.asList(), obj -> obj instanceof String);
        CUSTOM_NON_SOLID_BLOCKS = BUILDER.defineList("customNonSolidBlocks", Arrays.asList(), obj -> obj instanceof String);
        CUSTOM_THIN_BLOCKS = BUILDER.defineList("customThinBlocks", Arrays.asList(), obj -> obj instanceof String);
        CUSTOM_LIQUID_BLOCKS = BUILDER.defineList("customLiquidBlocks", Arrays.asList(), obj -> obj instanceof String);
        CUSTOM_AIR_BLOCKS = BUILDER.defineList("customAirBlocks", Arrays.asList(), obj -> obj instanceof String);
        BUILDER.pop();

        BUILDER.push("legacy_profiles");
        SPECIAL_MOB_PROFILES = BUILDER.comment("Legacy special mob profiles. Migrated to the new profile system.")
                .defineList("specialMobProfilesRaw", Arrays.asList(), obj -> obj instanceof String);
        SPECIAL_PLAYER_PROFILES = BUILDER.comment("Legacy special player profiles. Migrated to the new profile system.")
                .defineList("specialPlayerProfilesRaw", Arrays.asList(), obj -> obj instanceof String);
        BUILDER.pop();
        ...
        ARROW_REVERSE_EXTRAPOLATE_MAX_DISTANCE = BUILDER.comment("Blocks. Max distance to reverse-extrapolate arrow origin when owner is unknown.")
                .defineInRange("arrowReverseExtrapolateMaxDistance", 64.0, 0.0, 256.0);
        ...
        INVESTIGATE_PROJECTILE_IDS = BUILDER.comment(
                ...
                .defineList("investigateProjectileIds", Arrays.asList(
