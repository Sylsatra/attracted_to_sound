...
public class GeneralConfig {
    ...
    static {
        ...
        ENABLE_PLAYER_ACTION_SOUNDS = BUILDER.comment("Enable/disable virtual sound generation from player movements.")
                .define("enablePlayerActionSounds", true);
        PLAYER_ACTION_RANGES = BUILDER.comment("Base detection ranges for player actions. Format: 'ACTION;range'")
        ...
        PLAYER_ACTION_WEIGHTS = BUILDER.comment("Weights for player action sounds. Format: 'ACTION;weight'")
                .defineList("playerActionWeights", Arrays.asList(
                "CRAWLING;1.0", "SNEAKING;1.0", "WALKING;1.0", "SPRINTING;1.0", "SPRINT_JUMPING;1.0"
        ), obj -> obj instanceof String && ((String) obj).split(";").length == 2);
        PLAYER_ACTION_CHECK_RADIUS = BUILDER.comment("Radius within which to check for players to generate sounds.")
