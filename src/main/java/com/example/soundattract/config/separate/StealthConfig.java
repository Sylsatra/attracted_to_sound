...
public class StealthConfig {
    ...
    public static final ForgeConfigSpec.DoubleValue DEFAULT_HORIZONTAL_FOV;
    public static final ForgeConfigSpec.DoubleValue DEFAULT_VERTICAL_FOV;
    public static final ForgeConfigSpec.ConfigValue<List<? extends String>> CUSTOM_FOV_OVERRIDES;
    public static final ForgeConfigSpec.ConfigValue<List<? extends String>> FOV_EXCLUSION_LIST;
    public static final ForgeConfigSpec.ConfigValue<List<? extends String>> NON_BLOCKING_VISION_ALLOW_LIST;


    public static final ForgeConfigSpec.BooleanValue ENABLE_STEALTH_MECHANICS;
    public static final ForgeConfigSpec.IntValue STEALTH_CHECK_INTERVAL;
    public static final ForgeConfigSpec.IntValue STEALTH_GRACE_PERIOD_TICKS;
    public static final ForgeConfigSpec.DoubleValue MIN_STEALTH_DETECTION_RANGE;
    public static final ForgeConfigSpec.DoubleValue MAX_STEALTH_DETECTION_RANGE;


    public static final ForgeConfigSpec.DoubleValue STANDING_DETECTION_RANGE_PLAYER;
    public static final ForgeConfigSpec.DoubleValue SNEAKING_DETECTION_RANGE_PLAYER;
    public static final ForgeConfigSpec.DoubleValue CRAWLING_DETECTION_RANGE_PLAYER;


    public static final ForgeConfigSpec.IntValue NEUTRAL_LIGHT_LEVEL;
    public static final ForgeConfigSpec.DoubleValue LIGHT_LEVEL_SENSITIVITY;
    public static final ForgeConfigSpec.DoubleValue MIN_LIGHT_FACTOR;
    public static final ForgeConfigSpec.DoubleValue MAX_LIGHT_FACTOR;
    public static final ForgeConfigSpec.IntValue LIGHT_SAMPLE_RADIUS_HORIZONTAL;
    public static final ForgeConfigSpec.IntValue LIGHT_SAMPLE_RADIUS_VERTICAL;
    public static final ForgeConfigSpec.DoubleValue RAIN_STEALTH_FACTOR;
    public static final ForgeConfigSpec.DoubleValue THUNDER_STEALTH_FACTOR;


    public static final ForgeConfigSpec.DoubleValue MOVEMENT_STEALTH_PENALTY;
    public static final ForgeConfigSpec.DoubleValue STATIONARY_STEALTH_BONUS_FACTOR;
    public static final ForgeConfigSpec.DoubleValue MOVEMENT_THRESHOLD;
    public static final ForgeConfigSpec.DoubleValue INVISIBILITY_STEALTH_FACTOR;


    public static final ForgeConfigSpec.BooleanValue ENABLE_CAMOUFLAGE;
    public static final ForgeConfigSpec.BooleanValue ENABLE_HELD_ITEM_PENALTY;
    public static final ForgeConfigSpec.DoubleValue HELD_ITEM_PENALTY_FACTOR;
    public static final ForgeConfigSpec.BooleanValue ENABLE_ENCHANTMENT_PENALTY;
    public static final ForgeConfigSpec.DoubleValue ARMOR_ENCHANTMENT_PENALTY_FACTOR;
    public static final ForgeConfigSpec.DoubleValue HELD_ITEM_ENCHANTMENT_PENALTY_FACTOR;
    
    public static final ForgeConfigSpec.ConfigValue<List<? extends String>> CAMOUFLAGE_ARMOR_ITEMS;
    public static final ForgeConfigSpec.BooleanValue REQUIRE_FULL_SET_FOR_CAMOUFLAGE_BONUS;
    public static final ForgeConfigSpec.DoubleValue FULL_ARMOR_STEALTH_BONUS;
    public static final ForgeConfigSpec.DoubleValue HELMET_CAMOUFLAGE_EFFECTIVENESS;
    public static final ForgeConfigSpec.DoubleValue CHESTPLATE_CAMOUFLAGE_EFFECTIVENESS;
    public static final ForgeConfigSpec.DoubleValue LEGGINGS_CAMOUFLAGE_EFFECTIVENESS;
    public static final ForgeConfigSpec.DoubleValue BOOTS_CAMOUFLAGE_EFFECTIVENESS;
    public static final ForgeConfigSpec.DoubleValue MAX_CAMOUFLAGE_EFFECTIVENESS_CAP;
    public static final ForgeConfigSpec.BooleanValue ALLOW_PARTIAL_BONUS_IF_FULL_SET_REQUIRED;


    public static final ForgeConfigSpec.BooleanValue ENABLE_ENVIRONMENTAL_CAMOUFLAGE;
    public static final ForgeConfigSpec.BooleanValue ENABLE_ENVIRONMENTAL_MISMATCH_PENALTY;
    public static final ForgeConfigSpec.DoubleValue ENVIRONMENTAL_CAMOUFLAGE_MAX_EFFECTIVENESS;
    public static final ForgeConfigSpec.IntValue ENVIRONMENTAL_CAMOUFLAGE_COLOR_MATCH_THRESHOLD;
    public static final ForgeConfigSpec.DoubleValue ENVIRONMENTAL_MISMATCH_PENALTY_FACTOR;
    public static final ForgeConfigSpec.IntValue ENVIRONMENTAL_MISMATCH_THRESHOLD;
    public static final ForgeConfigSpec.BooleanValue ENVIRONMENTAL_CAMOUFLAGE_ONLY_DYED_LEATHER;
    public static final ForgeConfigSpec.ConfigValue<List<? extends String>> CUSTOM_ARMOR_COLORS;
    public static final ForgeConfigSpec.IntValue ENV_COLOR_SAMPLE_RADIUS;
    ...
    public static final ForgeConfigSpec.ConfigValue<String> ENVIRONMENTAL_CAMOUFLAGE_SAMPLING_MODE;
    public static final ForgeConfigSpec.IntValue ENV_BACKDROP_MAX_DISTANCE;
    public static final ForgeConfigSpec.IntValue ENV_BACKDROP_SAMPLE_RAYS;
    public static final ForgeConfigSpec.IntValue ENV_BACKDROP_MIN_SAMPLES;
    public static final ForgeConfigSpec.IntValue ENV_BACKDROP_VIEWER_CELL_SIZE;
    public static final ForgeConfigSpec.IntValue ENV_BACKDROP_CACHE_TTL_TICKS;
    public static final ForgeConfigSpec.DoubleValue ENV_BACKDROP_MIN_TPS;
    public static final ForgeConfigSpec.DoubleValue ENV_BACKDROP_RECOVERY_TPS;
    public static final ForgeConfigSpec.BooleanValue ENV_BACKDROP_USE_SKY_COLOR;
    public static final ForgeConfigSpec.ConfigValue<String> ENV_BACKDROP_DAY_SKY_COLOR;
    public static final ForgeConfigSpec.ConfigValue<String> ENV_BACKDROP_NIGHT_SKY_COLOR;
    public static final ForgeConfigSpec.ConfigValue<String> ENV_BACKDROP_RAIN_SKY_COLOR;
    ...
    static {
        ...
        FOV_EXCLUSION_LIST = BUILDER.comment("List of mobs that will COMPLETELY IGNORE the FOV system (e.g. Warden). They will have 360-degree vision.")
                .defineList("fovExclusionList", Collections.singletonList("minecraft:warden"), obj -> obj instanceof String && net.minecraft.resources.ResourceLocation.tryParse((String) obj) != null);
        NON_BLOCKING_VISION_ALLOW_LIST = BUILDER.comment("List of blocks that DO NOT block line-of-sight checks (e.g. glass, bars).")
                .defineList("nonBlockingVisionAllowList", Collections.emptyList(), obj -> obj instanceof String && net.minecraft.resources.ResourceLocation.tryParse((String) obj) != null);
        BUILDER.pop();
