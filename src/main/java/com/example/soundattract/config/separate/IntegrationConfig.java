...
public class IntegrationConfig {
    ...
    public static final ModConfigSpec.BooleanValue BLOCK_BREAKING_PROPER_TOOL_REQUIRED;
    public static final ModConfigSpec.IntValue BLOCK_BREAK_MAX_Y;
    public static final ModConfigSpec.BooleanValue BLOCK_BREAK_BLACKLIST_TILE_ENTITIES;
    public static final ModConfigSpec.BooleanValue BLOCK_BREAK_LIST_AS_WHITELIST;
    public static final ModConfigSpec.ConfigValue<List<? extends String>> BLOCK_BREAK_BLOCK_LIST;
    ...
    public static final ModConfigSpec.BooleanValue ENABLE_TOUGH_AS_NAILS_INTEGRATION;
    public static final ModConfigSpec.IntValue TOUGH_AS_NAILS_POLL_INTERVAL_TICKS;
    public static final ModConfigSpec.ConfigValue<List<? extends String>> TOUGH_AS_NAILS_TEMPERATURE_SCENT_MULTIPLIERS;
    public static final ModConfigSpec.DoubleValue TOUGH_AS_NAILS_HYPERTHERMIA_SCENT_MULTIPLIER;
    public static final ModConfigSpec.DoubleValue TOUGH_AS_NAILS_HYPERTHERMIA_SOUND_MULTIPLIER;
    public static final ModConfigSpec.DoubleValue TOUGH_AS_NAILS_THIRST_SCENT_MULTIPLIER_AT_EMPTY;
    public static final ModConfigSpec.DoubleValue TOUGH_AS_NAILS_THIRST_SOUND_MULTIPLIER_AT_EMPTY;
    public static final ModConfigSpec.DoubleValue TOUGH_AS_NAILS_WOOL_ARMOR_SOUND_MULTIPLIER_PER_PIECE;
    public static final ModConfigSpec.DoubleValue TOUGH_AS_NAILS_WOOL_ARMOR_MINIMUM_SOUND_MULTIPLIER;
    public static final ModConfigSpec.DoubleValue TOUGH_AS_NAILS_WOOL_WARM_SCENT_MULTIPLIER_PER_PIECE;
    public static final ModConfigSpec.DoubleValue TOUGH_AS_NAILS_WOOL_HOT_SCENT_MULTIPLIER_PER_PIECE;
    public static final ModConfigSpec.DoubleValue TOUGH_AS_NAILS_WOOL_HEAT_MAXIMUM_SCENT_MULTIPLIER;
    public static final ModConfigSpec.DoubleValue TOUGH_AS_NAILS_LEAF_ARMOR_SCENT_MULTIPLIER_PER_PIECE;
    public static final ModConfigSpec.DoubleValue TOUGH_AS_NAILS_LEAF_ARMOR_MINIMUM_SCENT_MULTIPLIER;
    ...
    static {
        ...
        BLOCK_BREAKING_PROPER_TOOL_REQUIRED = BUILDER.comment("If true, blocks requiring a correct tool can only be broken when the mob holds a suitable tool.")
                .define("blockBreakingProperToolRequired", false);
        BLOCK_BREAK_MAX_Y = BUILDER.comment("Maximum Y level where mobs are allowed to break blocks.")
                .defineInRange("blockBreakMaxY", 256, -2032, 4064);
        BLOCK_BREAK_BLACKLIST_TILE_ENTITIES = BUILDER.comment("Prevent mobs from breaking blocks with block entities, such as chests.")
                .define("blockBreakBlacklistTileEntities", true);
        BLOCK_BREAK_LIST_AS_WHITELIST = BUILDER.comment("Treat blockBreakBlockList as a whitelist when true, or as a blacklist when false.")
                .define("blockBreakListAsWhitelist", false);
        BLOCK_BREAK_BLOCK_LIST = BUILDER.comment("Block IDs used as a blacklist or whitelist for mob block breaking.")
                .defineList("blockBreakBlockList", Arrays.asList(), obj -> obj instanceof String);
