...
public class PathfindingConfig {
    ...
    public static final ModConfigSpec.BooleanValue ENABLE_FLOW_FIELD;
    public static final ModConfigSpec.IntValue FLOW_FIELD_MOB_THRESHOLD;
    public static final ModConfigSpec.IntValue MOVE_TO_COOLDOWN_TICKS;
    public static final ModConfigSpec.DoubleValue MOVE_TO_MIN_DELTA;
    public static final ModConfigSpec.IntValue MOVE_TO_TEAM_BUDGET_PER_TICK;
    public static final ModConfigSpec.IntValue MAX_PATH_ATTEMPTS_PER_TICK;
    public static final ModConfigSpec.BooleanValue ENABLE_NODE_ROUTER;
